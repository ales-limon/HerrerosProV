<?php
/**
 * Página de contacto de HerrerosPro
 * Este archivo carga el layout principal con el contenido de la página de contacto
 */
...
$content_path = __DIR__ . '/contacto_content.php';
